...
namespace me.tooster.sdf.Editor.NodeGraph.Nodes.MasterNodes {
    ...
    public record BasicVertToFragNode : Node, IVertexToFragmentNode {
        ...
        // v2f vertOut;
        private static AST.Hlsl.Syntax.Statements.Definitions.VariableDefinition VertToFragVariableDefinition => new AST.Hlsl.Syntax.Statements.Definitions.VariableDefinition
        {
        ...
        {
            VertToFragVariableDefinition,                                          // v2f vertOut;
