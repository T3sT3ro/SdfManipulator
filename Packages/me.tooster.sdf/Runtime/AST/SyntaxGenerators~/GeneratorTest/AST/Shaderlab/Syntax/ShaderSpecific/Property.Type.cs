...
namespace me.tooster.sdf.AST.Shaderlab.Syntax.ShaderSpecific {
    public partial record Property {
        [AstSyntax] public abstract partial record Type : Syntax<Shaderlab>;

        [AstSyntax] public partial record PredefinedType : Type {
        ...
        [AstSyntax] public partial record RangeType : Type {
