...
namespace AST.Shaderlab {
    ...
    public record Shader {
        ...
        public Identifier? fallback { get; set; }
        ...
        public record SubShader {
            ...
            public interface Command : Shaderlab.Command { }
        ...
        public record HlslInclude : Hlsl.Statement;

        public record HlslProgram : Hlsl.Statement;
        ...
        public record CustomEditorForRenderPipeline {
            public Identifier id       { get; set; }
            public Identifier pipeline { get; set; }
        }
    }
