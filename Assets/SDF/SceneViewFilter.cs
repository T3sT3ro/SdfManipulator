 ...
 * Source: https://github.com/Flafla2/Generic-Raymarch-Unity/blob/master/Assets/SceneViewFilter.cs
 */
...
namespace SDF {
    public class SceneViewFilter : MonoBehaviour {
        ...
        static void CheckMe(SceneView sv) {
            ...
            // If so, we simply destroy all scene filters and recreate from main camera
