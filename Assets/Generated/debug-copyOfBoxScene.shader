    ...
    SubShader {
        ...
        Pass {
            ...
            SdfResult _1_root(float3 p) {
                SdfResult result = sdf::operators::unionSmooth(sdf::operators::unionSmooth(sdf::operators::unionSmooth(_1_0_root_ground(p), sdf::operators::unionSmooth(_1_1_0_root_shroom_1_sphere_1(p), _1_1_1_root_shroom_1_cone(p), _1_root_BlendFactor), _1_root_BlendFactor), sdf::operators::unionSmooth(_1_2_0_root_shroom2_sphere_2(p), sdf::operators::unionSmooth(_1_2_1_root_shroom2_cone_2(p), _1_2_2_root_shroom2_sphere(p), _1_root_BlendFactor), _1_root_BlendFactor), _1_root_BlendFactor), sdf::operators::unionSmooth(sdf::operators::unionSmooth(_1_3_root_combine(p), sdf::operators::unionSmooth(_1_4_0_root_screw_cylinder(p), _1_4_1_root_screw_head(p), _1_root_BlendFactor), _1_root_BlendFactor), sdf::operators::unionSmooth(_1_5_root_q(p), sdf::operators::unionSmooth(_1_6_root_flat__1_(p), _1_7_root_combine(p), _1_root_BlendFactor), _1_root_BlendFactor), _1_root_BlendFactor), _1_root_BlendFactor);
                return result;
            }
